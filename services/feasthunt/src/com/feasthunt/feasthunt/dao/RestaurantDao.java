...
package com.feasthunt.feasthunt.dao;
...
/**
* Specifies methods used to obtain and modify Restaurant related information
* which is stored in the database.
*/
@Repository("feasthunt.RestaurantDao")
public class RestaurantDao extends WMGenericDaoImpl <Restaurant, Integer> {

    @Autowired
    @Qualifier("feasthuntTemplate")
