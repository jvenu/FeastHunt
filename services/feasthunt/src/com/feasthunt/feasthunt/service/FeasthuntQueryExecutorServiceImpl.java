...
@Service
public class FeasthuntQueryExecutorServiceImpl implements FeasthuntQueryExecutorService {
	private static final Logger LOGGER = LoggerFactory.getLogger(FeasthuntQueryExecutorServiceImpl.class);

	@Autowired
	@Qualifier("feasthuntWMQueryExecutor")
